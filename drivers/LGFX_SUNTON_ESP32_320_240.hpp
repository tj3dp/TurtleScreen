...
class Sunton_ESP32_320_240 : public lgfx::LGFX_Device {
...
public:
  Sunton_ESP32_320_240(void) {
    {
      auto cfg = _bus_instance.config();// バス設定用の構造体を取得します。
                                  // SPIバスの設定
      cfg.spi_host   = HSPI_HOST; //SPI2_HOST;  // 使用するSPIを選択 (VSPI_HOST or HSPI_HOST)
    ...
    }
    {
      ...
      cfg.rgb_order       = true; // パネルの赤と青が入れ替わる場合 trueに設定 ok
